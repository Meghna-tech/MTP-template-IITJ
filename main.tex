...
%%%%%%%%%%%%%%%% Change %%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\ttitle}{Development of Natural Language Processing Framework to mine HLA information from Biomedical abstracts}
\newcommand{\supname}{Dr. Dip Sankar Banerjee} 
\newcommand{\degree}{Masters of Technology}
\newcommand{\authorname}{Meghna Jain}
\newcommand{\rn}{M20CS057}
